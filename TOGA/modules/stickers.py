...
# convert gif method
    ...
    if msg.reply_to_message:
        ...
        packs_text = "*here are your sticker packs!*\n"
        if packnum > 0:        
        ...
        edited_keyboard = InlineKeyboardMarkup(
            [
             [
              InlineKeyboardButton(
               text="Stk-Pack", url=f"{packs}"),
             ],
             [
              InlineKeyboardButton(
               text="Vid-Pack", url=f"https://t.me/addstickers/video{user.id}_by_{context.bot.username}"),
              InlineKeyboardButton(
               text="Ani-Pack", url=f"https://t.me/addstickers/animated{user.id}_by_{context.bot.username}"),
             ],
            ]
        )
        msg.reply_text(
...
def makepack_internal(
    ...
    try:
        ...
        if png_sticker:
            sticker_pack_name = (
                f"{name}'s Pack : @Toga_Robot (@{context.bot.username})" + extra_version
            )
            ...
            msg.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                text="Un-block", url=f"https://t.me/{context.bot.username}"
                            )
                        ]
                    ]
                ),

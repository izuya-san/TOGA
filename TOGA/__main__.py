...
• Report Any Kind Of Bugs At [Support](t.me/BotsAtelier)
"""
...
SUMI_N_IMG = (
  "https://telegra.ph/file/03415a89fe0a51ad3b89f.png",
  "https://telegra.ph/file/03415a89fe0a51ad3b89f.png"
)

SUMI_VID = "https://telegra.ph/file/8d49b6f49362e7778785e.jpg"

PM_PHOTO = "https://telegra.ph/file/3c3c850d621b786a40e96.jpg"
            ...
            query.message.edit_caption(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="⬅ Bα¢к", callback_data="help_back"),
                      InlineKeyboardButton(text="⬅ Hσмє", callback_data="sumi_back")]]
                ),
            )
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    ...
                    InlineKeyboardButton(text="Developer", url="t.me/izuya"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="sumi_")
                 ],
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            ...
            m = dispatcher.bot.send_photo(f"@{SUPPORT_CHAT}", SUMI_DISPACHER_PIC, caption=f"I'm Online Again", parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                ]
            ),
